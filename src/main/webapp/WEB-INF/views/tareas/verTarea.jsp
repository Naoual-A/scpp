	...
	<div id="page-content-wrapper">
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input class="form-control" path="tarea.titulo" placeholder="Título" readonly="true"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:textarea rows="6" path="tarea.contenido" class="form-control" placeholder="Descripción" readonly="true"/>
				</div>
			</div>
